...
namespace LionPOSDbContracts.DomainModels.Product
{
    ...
    public partial class combo_items
    {
        public string comboItemsBranchCode { get; set; }
        public string sku { get; set; }
        public string productsEntryGroupCode { get; set; }
        public string combo_sku_item { get; set; }
        public string combo_productsEntryGroupCode_item { get; set; }
        ...
        public string entryByBranchCode { get; set; }
