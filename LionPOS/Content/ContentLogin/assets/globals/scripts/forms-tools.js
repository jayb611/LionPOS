var FormsTools = {
	...
	typeaheadPrefetch: function () {
		var countries = new Bloodhound({
			...
			prefetch: {
				...
				url: 'assets/plugins/typeahead/data/countries.json',
	...
	typeaheadCustom: function () {
		var bestPictures = new Bloodhound({
			...
			queryTokenizer: Bloodhound.tokenizers.whitespace,
			prefetch: 'assets/plugins/typeahead/data/post_1960.json',
			remote: 'assets/plugins/typeahead/data/query.php?query=%QUERY'
		});
	...
	typeaheadMultiple: function () {
		var nbaTeams = new Bloodhound({
			...
			queryTokenizer: Bloodhound.tokenizers.whitespace,
			prefetch: 'assets/plugins/typeahead/data/nba.json'
		});

		var nhlTeams = new Bloodhound({
			datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
			queryTokenizer: Bloodhound.tokenizers.whitespace,
			prefetch: 'assets/plugins/typeahead/data/nhl.json'
		});
