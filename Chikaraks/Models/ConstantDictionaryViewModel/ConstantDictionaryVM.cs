...
namespace Chikaraks.ConstantDictionaryViewModel
{
    public static class ConstantDictionaryVM
    {
        ...
        public const string LoginPageSession_string = "ChikaraksLoginPageSession";
        public const string NeedHelpPageSession_string = "ChikaraksNeedHelpPageSession";
        public const string CaptchaValueSession_string = "ChikaraksCaptchaValue";
        ...
        public const string ErrorMessage = "Contact developer as soon as possible,If you are on internet connection then an email is already sent to support team.\n Thank you";
        ...
        public const string AccessRoleSession_String = "ChikaraksAccessRole";
